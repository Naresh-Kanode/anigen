...
<head>
    ...
    <title>Gegege no Kitarou: Kitarou Tanjou-hen</title>
                        ...
                        <div class='card shadow m-2'>
                            ...
                            <h4 class='ms-2 text-dark text-center overflow-hidden' >$name</h4>
                                <div class='col-12 col-lg-4 col-md-4'>
                                    <img src='../assets/images/Gegege no Kitarou Kitarou Tanjou-hen.jpeg'class='w-100 border border-3 border-light p-2 '>
                                </div>
