...
<head>
    ...
    <title>Ninja Slayer From Animation</title>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<div class='container-fluid mt-4 mb-5 text-light'>
                        <div class='card shadow m-2'>
                            ...
                            <h4 class='ms-2 text-dark text-center'>Ninja Slayer From Animation</h4>
                                <div class='col-12 col-lg-4 col-md-4'>
                                    <img src='../assets/images/Ninja_Slayer_From_Animation.jpg' class='w-100 border border-3 border-light p-2 '>
                                </div>
