...
<head>
    ...
    <title>3 Choume no Tama: Uchi no Tama Shirimasenka?</title>
...
<body class="bg-light  text-light">
        ...
        <?php
        $id = 2467;
        $sql = "SELECT * FROM adventure WHERE anime_id = $id";
                        ...
                        <div class='card shadow m-2'>
                            ...
                            <h4 class='ms-2 text-dark text-center overflow-hidden' >$name</h4>
                                <div class='col-12 col-lg-4 col-md-4'>
                                    <img src='../assets/images/3 Choume no Tama Uchi no Tama Shirimasenka.jpg'class='w-100 border border-3 border-light p-2 '>
                                </div>
