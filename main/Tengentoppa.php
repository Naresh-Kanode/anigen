...
<head>
    ...
    <title>Tengen Toppa Gurren Lagann: Parallel Works</title>
...
<body class="bg-light  text-light">
        ...
        <?php
        $id = 4705;
        $sql = "SELECT * FROM music WHERE anime_id = $id";
                        ...
                        <div class='card shadow m-2'>
                            ...
                            <h4 class='ms-2 text-dark text-center overflow-hidden' >$name</h4>
                                <div class='col-12 col-lg-4 col-md-4'>
                                    <img src='../assets/images/Tengen Toppa Gurren Lagann Parallel Works.jpg'class='w-100 border border-3 border-light p-2 '>
                                </div>
