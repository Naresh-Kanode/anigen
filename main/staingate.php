...
<head>
    ...
    <title>Steins;Gate: Soumei Eichi no Cognitive Computing</title>
                        ...
                        <div class='card shadow m-2'>
                            ...
                            <h4 class='ms-2 text-dark text-center overflow-hidden' >$name</h4>
                                <div class='col-12 col-lg-4 col-md-4'>
                                    <img src='../assets/images/SteinsGate Soumei Eichi no Cognitive Computing.jpg'class='w-100 border border-3 border-light p-2 '>
                                </div>
