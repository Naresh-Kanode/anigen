...
<head>
    ...
    <title>Natsu-iro Kiseki: 15-kaime no Natsuyasumi</title>
...
<body class="bg-light  text-light">
        ...
        <?php
        $id = 15431;
        $sql = "SELECT * FROM slice_of_life WHERE anime_id = $id";
                        ...
                        <div class='card shadow m-2'>
                            ...
                            <h4 class='ms-2 text-dark text-center overflow-hidden' >$name</h4>
                                <div class='col-12 col-lg-4 col-md-4'>
                                    <img src='../assets/images/NatsuiroKiseki.jpg'class='w-100 border border-3 border-light p-2 '>
                                </div>
