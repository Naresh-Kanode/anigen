                ...
                if ($result) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <div class='card shadow m-2'>
                            ...
                            <h4 class='ms-2 text-dark text-center'>Kara The Animation</h4>
                                <div class='col-12 col-lg-4 col-md-4'>
                                    <img src='../assets/images/Kara_The_Animation.jpg' class='w-100 border border-3 border-light p-2 '>
                                </div>
