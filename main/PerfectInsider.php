...
<head>
    ...
    <title> The Perfect Insider</title>
...
<body class="bg-light  text-light">
        ...
        <?php
        $id = 10013;
        $sql = "SELECT * FROM mystery WHERE anime_id = $id";
                        ...
                        <div class='card shadow m-2'>
                            ...
                            <h4 class='ms-2 text-dark text-center overflow-hidden' >$name</h4>
                                <div class='col-12 col-lg-4 col-md-4'>
                                    <img src='../assets/images/PerfectInsider.jpgjpeg'class='w-100 border border-3 border-light p-2 '>
                                </div>
