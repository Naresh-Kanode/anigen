    ...
    if ($result) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<div class=' container-fluid mt-4 mb-5'>
                        <div class=' card shadow m-2 'style='background: linear-gradient(to top, #11998e, #38ef7d)';>
                            <div class='row d-lg-flex mt-2 p-3'>
                            <h4 class='ms-2 text-dark text-center overflow-hidden' >$name</h4>
                                <div class='col-12 col-lg-4 col-md-4'>
                                    <img src='images/demons_slyer.jpg 'class='w-100 border border-3 border-light p-2 '>
                                </div>
                                ...
                                <label class='text-light bg-success rounded w-100 fw-bold text-center p-2'>Synopsis</label>
